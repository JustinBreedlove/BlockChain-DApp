...
export interface Counter extends BaseContract {
  ...
  getArray: TypedContractMethod<[], [string[]], "view">;
  ...
  spliceArray: TypedContractMethod<[num: BigNumberish], [string[]], "view">;
